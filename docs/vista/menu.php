...
<aside class="app-sidebar">
    <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="" alt="User Image">
        <div>
            <p class="app-sidebar__user-name">Alejandro</p>
    ...
    <ul class="app-menu">
        ...
        <li><a class="app-menu__item" href="RegistroPersona.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Registro Persona</span></a></li>
